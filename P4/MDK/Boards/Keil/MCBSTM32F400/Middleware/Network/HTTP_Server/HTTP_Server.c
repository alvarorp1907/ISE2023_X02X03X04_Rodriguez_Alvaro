...
/* Read analog inputs */
uint16_t AD_in (uint32_t ch) {//FUNCION MODIFICADA PARA USAR EN NUESTRA PLACA
  
	int32_t value=ADC_getVoltage(&adc , ch);//get values from channel 10->ADC123_IN10
